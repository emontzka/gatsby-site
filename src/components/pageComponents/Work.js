                    ...
                    <>
                        ...
                        <InfoPanel className={this.state.panelOpen ? "open" : ""}>
                            ...
                            <IconContainer >
                                ...
                                {acf.portfolio_url && (
                                    <a style={{ color: '#000' }} href={acf.portfolio_url} target="_blank" rel="noopener noreferrer"><FontAwesomeIcon style={{ fontSize: '30px', marginRight: '15px' }} icon={faExternalLinkAlt} /></a>
                                )}
